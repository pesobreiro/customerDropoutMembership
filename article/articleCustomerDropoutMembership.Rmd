...
```{python createModel, eval=FALSE, echo=FALSE, cache = FALSE, warning = FALSE}
...
clusters... corrigir acima para selecionar só as features.. Explorar t-SNE for better visualization... 
...
The results of the performance of the models are available in table 4.
Colocar o modelo. Resultados do modelo
```{=latex}
\begin{table}[ht]
    \footnotesize
    \centering
    \begin{tabular}{p{0.15\textwidth}p{0.55\textwidth}p{0.25\textwidth}}
    \hline
    \textbf{Model name} & \textbf{Results} \\
    \hline
    Survival trees  & RMSE 2.77 Median Absolute Error 0.0 \\
    Survival trees
    with clusters   & Cluster 1: RMSE  2.775 Median Absolute Error  0.000 
                      Cluster 3: RMSE  8.769 Median Absolute Error  1.276
                      Cluster 2: RMSE 14.883 Median Absolute Error  2.030
                      Cluster 4: RMSE  9.624 Median Absolute Error  4.748
                      Cluster 0: RMSE 77.236 Median Absolute Error 26.066 \\
    Scikit survival 
