...
combinated with churn prediction [@hung_applying_2006; @gok_case_2015;
...
```{python pysurvivalperformance, eval=TRUE, echo=FALSE, cache=TRUE, warning = FALSE}
...
similar to the actual value. The absolute error mean of \~37 customers.
