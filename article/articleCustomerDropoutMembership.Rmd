...
clusters... corrigir acima para selecionar só as features.. Explorart-SNE for better visualization... 
...
for cluster in df_members.cluster.unique():
    ...
    c_index = concordance_index(csf, X_test, t_test, e_test)
    ibs = integrated_brier_score(csf, X_test, t_test, e_test, t_max=12, figure_size=(12,5))
    results_clusters = compare_to_actual(csf, X_test, t_test, e_test, is_at_risk = False,  figure_size=(12, 6), 
